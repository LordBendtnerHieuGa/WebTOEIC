...
namespace WebToeic.WebAppMVC.Controllers
{
    public class UserInforController : Controller
    {
        ...
        public UserInforController(UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<Role> roleManager)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> EditInforUser(string id)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> EditInforUser(InforVM infor)
        {
